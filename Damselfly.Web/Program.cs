...
public class Program
{
    ...
    private static void StartWebServer(DamselflyOptions cmdLineOptions, string[] args)
    {
        try
        {
            ...
            builder.Services
                .AddDefaultIdentity<AppIdentityUser>(options => options.SignIn.RequireConfirmedAccount = false)
            ...
            builder.Services
                .AddScoped<AuthenticationStateProvider,
                    RevalidatingIdentityAuthenticationStateProvider<AppIdentityUser>>();
