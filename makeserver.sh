...
zip -r -x ".pdb" ../../../../../../server/damselfly-server-mac-$version.zip *.*
cd ../../../../../..

echo Zipping Windows Server...
cd Damselfly.Web/bin/Release/net5.0/win-x64/publish
zip -r -x ".pdb" ../../../../../../server/damselfly-server-windows-$version.zip *.*
cd ../../../../../..

echo Zipping Linux Server...
cd Damselfly.Web/bin/Release/net5.0/linux-x64/publish
zip -r -x ".pdb" ../../../../../../server/damselfly-server-linux-$version.zip *.* 
cd ../../../../../..
